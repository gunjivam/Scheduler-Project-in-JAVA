...
public class ReadyQueue {
	...
	public Queue<Process> SimpleQueue;
	public MinHeap<Process> PriorityQueue;
	
	public void setSimpleQueue() {
		this.SimpleQueue = new LinkedList<Process>();
	}
	
	public void setPriorityQueue(int size, Comparator<Process> alg) {
		this.PriorityQueue = new MinHeap<Process>(size, alg);
	}
